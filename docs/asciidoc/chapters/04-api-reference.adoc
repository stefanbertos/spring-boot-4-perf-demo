...
The perf-tester module exposes REST APIs for performance testing, Kafka topic administration, IBM MQ queue administration, and runtime log level management. All APIs are documented using OpenAPI 3.0 specification.
